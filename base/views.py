...
def room(request, pk):
    ...
    context = {'room':room,
               'room_messages':room_messages,
               'participants':participants,'room_count': room_count
               }
...
def deleteRoom(request,pk):
    room  = Room.objects.get(id=pk)  #get the id of the room
...
def deleteMessage(request,pk):
    message  = Message.objects.get(id=pk)  #get the id of the room
    
    if request.user != message.user:
        return HttpResponse('You are not allowed to do this.You did not created this room')
